inherited churrasqueiraFrm: TchurrasqueiraFrm
        ...
        inherited pnl3: TPanel
          ...
          inherited grp2: TGroupBox
            ...
            inherited Lista1: TDBGrid
              Width = 664
              Height = 379
              DataSource = churrasqueiraDm.dsLista
        ...
        inherited pnl5: TPanel
          ...
          inherited grp3: TGroupBox
            ...
            object Label7: TLabel
              ...
              Width = 102
              Height = 13
              Caption = 'Valor Taxa Terceiros:'
              FocusControl = dbNVLTTCHURR
            end
            object dbNCODICHURR: TDBEdit
              Tag = 99
              Left = 80
              Top = 9
              Width = 134
              ...
              DataSource = churrasqueiraDm.dsManipula
              ReadOnly = True
              TabOrder = 0
            end
            object dbCDESCCHURR: TDBEdit
              Tag = 2
              Left = 80
              Top = 36
              Width = 481
              ...
              Hint = '"Descricao"'
              CharCase = ecUpperCase
              DataField = 'CDESCCHURR'
              DataSource = churrasqueiraDm.dsManipula
              TabOrder = 1
            end
            object dbchkCSTATCHURR: TDBCheckBox
              Left = 512
              Top = 65
              Width = 49
              Height = 17
              Caption = 'Ativo'
              DataField = 'CSTATCHURR'
              DataSource = churrasqueiraDm.dsManipula
              TabOrder = 4
              ValueChecked = 'A'
              ValueUnchecked = 'I'
            end
            object dbNVLTXCHURR: TDBEdit
              Left = 80
              Top = 63
              Width = 134
              Height = 21
              DataField = 'NVLTXCHURR'
              DataSource = churrasqueiraDm.dsManipula
              TabOrder = 2
            end
            object grpDias: TGroupBox
              Left = 78
              Top = 90
              Width = 483
              Height = 71
              Caption = ' Dias Permitidos para Reservas '
              TabOrder = 5
              object dbchkCDPSGCHURR: TDBCheckBox
                Left = 24
                Top = 19
                Width = 97
                Height = 17
                Caption = 'Segunda-Feira'
                DataField = 'CDPSGCHURR'
                DataSource = churrasqueiraDm.dsManipula
                TabOrder = 0
                ValueChecked = 'S'
                ValueUnchecked = 'N'
              end
              object dbchkCDPTECHURR: TDBCheckBox
                Left = 133
                Top = 19
                Width = 97
                Height = 17
                Caption = 'Ter'#231'a-Feira'
                DataField = 'CDPTECHURR'
                DataSource = churrasqueiraDm.dsManipula
                TabOrder = 1
                ValueChecked = 'S'
                ValueUnchecked = 'N'
              end
              object dbchkCDPQACHURR: TDBCheckBox
                Left = 248
                Top = 19
                Width = 97
                Height = 17
                Caption = 'Quarta-Feira'
                DataField = 'CDPQACHURR'
                DataSource = churrasqueiraDm.dsManipula
                TabOrder = 2
                ValueChecked = 'S'
                ValueUnchecked = 'N'
              end
              object dbchkCDPQICHURR: TDBCheckBox
                Left = 363
                Top = 19
                Width = 97
                Height = 17
                Caption = 'Quinta-Feira'
                DataField = 'CDPQICHURR'
                DataSource = churrasqueiraDm.dsManipula
                TabOrder = 3
                ValueChecked = 'S'
                ValueUnchecked = 'N'
              end
              object dbchkCDPSECHURR: TDBCheckBox
                Left = 24
                Top = 44
                Width = 97
                Height = 17
                Caption = 'Sexta-Feira'
                DataField = 'CDPSECHURR'
                DataSource = churrasqueiraDm.dsManipula
                TabOrder = 4
                ValueChecked = 'S'
                ValueUnchecked = 'N'
              end
              object dbchkCDPSACHURR: TDBCheckBox
                Left = 133
                Top = 44
                Width = 63
                Height = 17
                Caption = 'S'#225'bado'
                DataField = 'CDPSACHURR'
                DataSource = churrasqueiraDm.dsManipula
                TabOrder = 5
                ValueChecked = 'S'
                ValueUnchecked = 'N'
              end
              object dbchkCDPDOCHURR: TDBCheckBox
                Left = 248
                Top = 44
                Width = 86
                Height = 17
                Caption = 'Domingo'
                DataField = 'CDPDOCHURR'
                DataSource = churrasqueiraDm.dsManipula
                TabOrder = 6
                ValueChecked = 'S'
                ValueUnchecked = 'N'
            ...
            object dbNVLTTCHURR: TDBEdit
              Left = 372
              Top = 63
              Width = 134
              Height = 21
              DataField = 'NVLTTCHURR'
              DataSource = churrasqueiraDm.dsManipula
              TabOrder = 3
            end
          end
          object grp6: TGroupBox
            ...
            Height = 309
            Align = alClient
            Caption = 'Lista de subcategorias: '
            TabOrder = 1
            object pnl6: TPanel
              Tag = 2
              Left = 2
              ...
              object ts3: TTabSheet
                ...
                object pnl7: TPanel
                  ...
                  object DBGrid1: TDBGrid
                    ...
                    Align = alClient
                    BorderStyle = bsNone
                    DataSource = pertenceDeChurrasqueiraDm.dsLista
                ...
                object pnl8: TPanel
                  ...
                  object grp5: TGroupBox
                    ...
                    object DBEdit3: TDBEdit
                      ...
                      TabStop = False
                      Color = clSilver
                      DataField = 'NCODIPECHU'
                      DataSource = pertenceDeChurrasqueiraDm.dsManipula
                      ReadOnly = True
                      TabOrder = 0
                    end
